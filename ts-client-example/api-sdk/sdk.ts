...
export default function BuildSDK(apiBaseUrl: string) { return {
	...
	fetch(
		replacePathAndQueryVariables(`${apiBaseUrl}/api/posts/api/posts/`, undefined, undefined),
		{
			method: "POST",
...
,
	...
	fetch(
		replacePathAndQueryVariables(`${apiBaseUrl}/api/posts/api/posts/{id}`, args, undefined),
		{
			method: "GET",
		}
	)
